...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field collaborators on 'Makey'
        m2m_table_name = db.shorten_name(u'catalog_makey_collaborators')
        ...
        db.create_unique(m2m_table_name, ['makey_id', 'facebookcustomuser_id'])


    def backwards(self, orm):
        # Removing M2M table for field collaborators on 'Makey'
        db.delete_table(db.shorten_name(u'catalog_makey_collaborators'))
