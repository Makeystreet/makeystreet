...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserInteraction.model_id'
        db.delete_column(u'catalog_userinteraction', 'model_id')

        # Adding field 'UserInteraction.event_id'
        db.add_column(u'catalog_userinteraction', 'event_id',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserInteraction.model_id'
        db.add_column(u'catalog_userinteraction', 'model_id',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Deleting field 'UserInteraction.event_id'
        db.delete_column(u'catalog_userinteraction', 'event_id')
