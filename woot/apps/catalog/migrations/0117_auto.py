...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field admins on 'Listing'
        m2m_table_name = db.shorten_name(u'catalog_listing_admins')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('listing', models.ForeignKey(orm['catalog.listing'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['listing_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field admins on 'Listing'
        db.delete_table(db.shorten_name(u'catalog_listing_admins'))
