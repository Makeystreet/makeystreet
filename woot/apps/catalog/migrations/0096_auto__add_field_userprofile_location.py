...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'catalog_userprofile', 'location',
                      self.gf('django.db.models.fields.CharField')(default='Bangalore, India', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.location'
        db.delete_column(u'catalog_userprofile', 'location')
