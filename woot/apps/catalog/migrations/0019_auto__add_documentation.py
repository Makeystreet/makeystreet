...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'catalog_documentation', (
        ...
        db.send_create_signal(u'catalog', ['Documentation'])

        # Adding M2M table for field documentations on 'Makey'
        m2m_table_name = db.shorten_name(u'catalog_makey_documentations')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('makey', models.ForeignKey(orm[u'catalog.makey'], null=False)),
            ('documentation', models.ForeignKey(orm[u'catalog.documentation'], null=False))
        ))
        db.create_unique(m2m_table_name, ['makey_id', 'documentation_id'])


    def backwards(self, orm):
        # Deleting model 'Documentation'
        db.delete_table(u'catalog_documentation')

        # Removing M2M table for field documentations on 'Makey'
        db.delete_table(db.shorten_name(u'catalog_makey_documentations'))
