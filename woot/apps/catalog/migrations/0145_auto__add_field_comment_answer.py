...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Comment.answer'
        db.add_column(u'catalog_comment', 'answer',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='comments', null=True, to=orm['catalog.Answer']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Comment.answer'
        db.delete_column(u'catalog_comment', 'answer_id')
