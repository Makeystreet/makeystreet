...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserFlags'
        db.create_table(u'catalog_userflags', (
            ...
            ('show_makey_intro', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('show_maker_intro', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_facebook.FacebookCustomUser'])),
        ))
        db.send_create_signal('catalog', ['UserFlags'])


    def backwards(self, orm):
        # Deleting model 'UserFlags'
        db.delete_table(u'catalog_userflags')
