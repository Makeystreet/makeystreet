...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LikeMakey.fb_like_id'
        db.alter_column(u'catalog_likemakey', 'fb_like_id', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'LikeMakey.fb_like_id'
        db.alter_column(u'catalog_likemakey', 'fb_like_id', self.gf('django.db.models.fields.IntegerField')(default=1))
