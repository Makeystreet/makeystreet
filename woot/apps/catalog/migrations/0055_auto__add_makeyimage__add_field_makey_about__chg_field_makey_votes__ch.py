...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MakeyImage'
        db.create_table(u'catalog_makeyimage', (
            ...
            ('makey_id', self.gf('django.db.models.fields.IntegerField')()),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal('catalog', ['MakeyImage'])

        # Adding field 'Makey.about'
        db.add_column(u'catalog_makey', 'about',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Makey.votes'
        db.alter_column(u'catalog_makey', 'votes', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Makey.description'
        db.alter_column(u'catalog_makey', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Makey.url'
        db.alter_column(u'catalog_makey', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):
        # Deleting model 'MakeyImage'
        db.delete_table(u'catalog_makeyimage')

        # Deleting field 'Makey.about'
        db.delete_column(u'catalog_makey', 'about')


        # Changing field 'Makey.votes'
        db.alter_column(u'catalog_makey', 'votes', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Makey.description'
        db.alter_column(u'catalog_makey', 'description', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Makey.url'
        db.alter_column(u'catalog_makey', 'url', self.gf('django.db.models.fields.URLField')(default='http://www.makeystreet.com', max_length=200))
    ...
    models = {
        ...
        'catalog.makey': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'images': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'makeyimages'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['catalog.MakeyImage']"}),
            'is_enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
