...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TopMakeys.added_time'
        db.add_column(u'catalog_topmakeys', 'added_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 3, 0, 0)),
                      keep_default=False)

        # Adding field 'TopMakeys.is_enabled'
        db.add_column(u'catalog_topmakeys', 'is_enabled',
        ...
        # Adding field 'TopProducts.added_time'
        db.add_column(u'catalog_topproducts', 'added_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 3, 0, 0)),
                      keep_default=False)

        # Adding field 'TopProducts.is_enabled'
        db.add_column(u'catalog_topproducts', 'is_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
        ...
        # Adding field 'TopUsers.added_time'
        db.add_column(u'catalog_topusers', 'added_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 3, 0, 0)),
                      keep_default=False)

        # Adding field 'TopUsers.is_enabled'
        db.add_column(u'catalog_topusers', 'is_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
        ...
        # Adding field 'TopShops.added_time'
        db.add_column(u'catalog_topshops', 'added_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 3, 0, 0)),
                      keep_default=False)

        # Adding field 'TopShops.is_enabled'
        db.add_column(u'catalog_topshops', 'is_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
        ...
        # Adding field 'TopTutorials.added_time'
        db.add_column(u'catalog_toptutorials', 'added_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 3, 0, 0)),
                      keep_default=False)

        # Adding field 'TopTutorials.is_enabled'
        db.add_column(u'catalog_toptutorials', 'is_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'TopMakeys.added_time'
        db.delete_column(u'catalog_topmakeys', 'added_time')

        # Deleting field 'TopMakeys.is_enabled'
        db.delete_column(u'catalog_topmakeys', 'is_enabled')

        # Deleting field 'TopMakeys.score'
        db.delete_column(u'catalog_topmakeys', 'score')

        # Deleting field 'TopProducts.added_time'
        db.delete_column(u'catalog_topproducts', 'added_time')

        # Deleting field 'TopProducts.is_enabled'
        db.delete_column(u'catalog_topproducts', 'is_enabled')

        # Deleting field 'TopProducts.score'
        db.delete_column(u'catalog_topproducts', 'score')

        # Deleting field 'TopUsers.added_time'
        db.delete_column(u'catalog_topusers', 'added_time')

        # Deleting field 'TopUsers.is_enabled'
        db.delete_column(u'catalog_topusers', 'is_enabled')

        # Deleting field 'TopUsers.score'
        db.delete_column(u'catalog_topusers', 'score')

        # Deleting field 'TopShops.added_time'
        db.delete_column(u'catalog_topshops', 'added_time')

        # Deleting field 'TopShops.is_enabled'
        db.delete_column(u'catalog_topshops', 'is_enabled')

        # Deleting field 'TopShops.score'
        db.delete_column(u'catalog_topshops', 'score')

        # Deleting field 'TopTutorials.added_time'
        db.delete_column(u'catalog_toptutorials', 'added_time')

        # Deleting field 'TopTutorials.is_enabled'
        db.delete_column(u'catalog_toptutorials', 'is_enabled')
