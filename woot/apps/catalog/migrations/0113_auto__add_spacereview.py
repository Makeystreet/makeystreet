...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'catalog_spacereview', (
            ...
            ('review', self.gf('django.db.models.fields.CharField')(max_length=100000)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('rating', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('votes', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('space', self.gf('django.db.models.fields.related.ForeignKey')(related_name='space_reviews', to=orm['catalog.Space'])),
        ))
        db.send_create_signal('catalog', ['SpaceReview'])

        # Adding M2M table for field comments on 'Space'
        m2m_table_name = db.shorten_name(u'catalog_space_comments')
        ...
        db.create_unique(m2m_table_name, ['space_id', 'comment_id'])


    def backwards(self, orm):
        # Deleting model 'SpaceReview'
        db.delete_table(u'catalog_spacereview')

        # Removing M2M table for field comments on 'Space'
        db.delete_table(db.shorten_name(u'catalog_space_comments'))
