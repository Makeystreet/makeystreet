...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NewInventory'
        db.create_table(u'catalog_newinventory', (
            ...
            ('part', self.gf('django.db.models.fields.related.ForeignKey')(related_name='new_inventory_part', to=orm['catalog.NewProduct'])),
            ('space', self.gf('django.db.models.fields.related.ForeignKey')(related_name='new_inventory_space', to=orm['catalog.Space'])),
            ('quantity', self.gf('django.db.models.fields.IntegerField')(default=1, null=True, blank=True)),
        ))
        db.send_create_signal('catalog', ['NewInventory'])

        # Adding unique constraint on 'NewInventory', fields ['part', 'space']
        db.create_unique(u'catalog_newinventory', ['part_id', 'space_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'NewInventory', fields ['part', 'space']
        db.delete_unique(u'catalog_newinventory', ['part_id', 'space_id'])

        # Deleting model 'NewInventory'
        db.delete_table(u'catalog_newinventory')
