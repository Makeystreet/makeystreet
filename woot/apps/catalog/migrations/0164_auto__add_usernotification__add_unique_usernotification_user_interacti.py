...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'catalog_usernotification', (
            ...
            ('interaction', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.UserInteraction'])),
            ('read', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('catalog', ['UserNotification'])

        # Adding unique constraint on 'UserNotification', fields ['user', 'interaction']
        db.create_unique(u'catalog_usernotification', ['user_id', 'interaction_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserNotification', fields ['user', 'interaction']
        db.delete_unique(u'catalog_usernotification', ['user_id', 'interaction_id'])

        # Deleting model 'UserNotification'
        db.delete_table(u'catalog_usernotification')
