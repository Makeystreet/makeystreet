...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'catalog_cfistoreitem', (
            ...
            ('item', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['catalog.Product'], unique=True)),
        ))
        db.send_create_signal('catalog', ['CfiStoreItem'])

        # Adding model 'LikeCfiStoreItem'
        db.create_table(u'catalog_likecfistoreitem', (
            ...
            ('cfi_store_item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.CfiStoreItem'])),
        ))
        db.send_create_signal('catalog', ['LikeCfiStoreItem'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'LikeCfiStoreItem'
        db.delete_table(u'catalog_likecfistoreitem')
