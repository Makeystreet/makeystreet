...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tutorial.description'
        db.alter_column(u'catalog_tutorial', 'description', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Makey.description'
        db.alter_column(u'catalog_makey', 'description', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Makey.name'
        db.alter_column(u'catalog_makey', 'name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Tutorial.description'
        db.alter_column(u'catalog_tutorial', 'description', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
