...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LogIdenticalProduct'
        db.create_table(u'catalog_logidenticalproduct', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_facebook.FacebookCustomUser'])),
            ('product1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='product1', to=orm['catalog.Product'])),
            ('product2', self.gf('django.db.models.fields.related.ForeignKey')(related_name='product2', to=orm['catalog.Product'])),
            ('time', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'catalog', ['LogIdenticalProduct'])


    def backwards(self, orm):
        # Deleting model 'LogIdenticalProduct'
        db.delete_table(u'catalog_logidenticalproduct')
