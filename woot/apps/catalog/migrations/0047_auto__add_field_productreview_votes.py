...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductReview.votes'
        db.add_column(u'catalog_productreview', 'votes',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductReview.votes'
        db.delete_column(u'catalog_productreview', 'votes')
