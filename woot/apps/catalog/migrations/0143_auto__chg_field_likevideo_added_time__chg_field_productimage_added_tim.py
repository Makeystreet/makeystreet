...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LikeVideo.added_time'
        db.alter_column(u'catalog_likevideo', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ProductImage.added_time'
        db.alter_column(u'catalog_productimage', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'VoteShopReview.added_time'
        db.alter_column(u'catalog_voteshopreview', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'MakeyImage.added_time'
        db.alter_column(u'catalog_makeyimage', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'LikeCfiStoreItem.added_time'
        db.alter_column(u'catalog_likecfistoreitem', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Like.added_time'
        db.alter_column(u'catalog_like', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Article.added_time'
        db.alter_column(u'catalog_article', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'FavoriteMakey.added_time'
        db.alter_column(u'catalog_favoritemakey', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Product.added_time'
        db.alter_column(u'catalog_product', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'LikeShop.added_time'
        db.alter_column(u'catalog_likeshop', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Image.added_time'
        db.alter_column(u'catalog_image', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Tutorial.added_time'
        db.alter_column(u'catalog_tutorial', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
        # Adding M2M table for field comments on 'Answer'
        m2m_table_name = db.shorten_name(u'catalog_answer_comments')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('answer', models.ForeignKey(orm['catalog.answer'], null=False)),
            ('comment', models.ForeignKey(orm['catalog.comment'], null=False))
        ))
        db.create_unique(m2m_table_name, ['answer_id', 'comment_id'])


        # Changing field 'ArticleEmail.added_time'
        db.alter_column(u'catalog_articleemail', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'LikeImage.added_time'
        db.alter_column(u'catalog_likeimage', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'NewUser.added_time'
        db.alter_column(u'catalog_newuser', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'LikeListing.added_time'
        db.alter_column(u'catalog_likelisting', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'LikeNote.added_time'
        db.alter_column(u'catalog_likenote', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'VoteProductReview.added_time'
        db.alter_column(u'catalog_voteproductreview', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'LikeProductTutorial.added_time'
        db.alter_column(u'catalog_likeproducttutorial', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'InstructableStep.added_time'
        db.alter_column(u'catalog_instructablestep', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'LikeChannel.added_time'
        db.alter_column(u'catalog_likechannel', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ProductShopUrl.added_time'
        db.alter_column(u'catalog_productshopurl', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
        ...
        # Changing field 'UpFile.added_time'
        db.alter_column(u'catalog_upfile', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ListItem.added_time'
        db.alter_column(u'catalog_listitem', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Comment.added_time'
        db.alter_column(u'catalog_comment', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'UserProfile.added_time'
        db.alter_column(u'catalog_userprofile', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'List.added_time'
        db.alter_column(u'catalog_list', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ListGroup.added_time'
        db.alter_column(u'catalog_listgroup', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Documentation.added_time'
        db.alter_column(u'catalog_documentation', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Shop.added_time'
        db.alter_column(u'catalog_shop', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'CfiStoreItem.added_time'
        db.alter_column(u'catalog_cfistoreitem', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Note.added_time'
        db.alter_column(u'catalog_note', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Makey.added_time'
        db.alter_column(u'catalog_makey', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'UserFlags.added_time'
        db.alter_column(u'catalog_userflags', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'LikeProductImage.added_time'
        db.alter_column(u'catalog_likeproductimage', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'SpaceReview.added_time'
        db.alter_column(u'catalog_spacereview', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Location.added_time'
        db.alter_column(u'catalog_location', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'NewInventory.added_time'
        db.alter_column(u'catalog_newinventory', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'LikeArticle.added_time'
        db.alter_column(u'catalog_likearticle', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'LikeProductDescription.added_time'
        db.alter_column(u'catalog_likeproductdescription', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Listing.added_time'
        db.alter_column(u'catalog_listing', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'VoteMakey.added_time'
        db.alter_column(u'catalog_votemakey', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ProductReview.added_time'
        db.alter_column(u'catalog_productreview', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'LikeProduct.added_time'
        db.alter_column(u'catalog_likeproduct', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Video.added_time'
        db.alter_column(u'catalog_video', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'TopProducts.added_time'
        db.alter_column(u'catalog_topproducts', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'NewProduct.added_time'
        db.alter_column(u'catalog_newproduct', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'UserInteraction.added_time'
        db.alter_column(u'catalog_userinteraction', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'TopMakeys.added_time'
        db.alter_column(u'catalog_topmakeys', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'LikeMakey.added_time'
        db.alter_column(u'catalog_likemakey', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'TopTutorials.added_time'
        db.alter_column(u'catalog_toptutorials', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'VoteTutorial.added_time'
        db.alter_column(u'catalog_votetutorial', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'TopUsers.added_time'
        db.alter_column(u'catalog_topusers', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ShopReview.added_time'
        db.alter_column(u'catalog_shopreview', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'VoteSpaceReview.added_time'
        db.alter_column(u'catalog_votespacereview', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'TopShops.added_time'
        db.alter_column(u'catalog_topshops', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'TextDocumentation.added_time'
        db.alter_column(u'catalog_textdocumentation', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Space.added_time'
        db.alter_column(u'catalog_space', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'LikeComment.added_time'
        db.alter_column(u'catalog_likecomment', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ProductDescription.added_time'
        db.alter_column(u'catalog_productdescription', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Inventory.added_time'
        db.alter_column(u'catalog_inventory', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ArticleTag.added_time'
        db.alter_column(u'catalog_articletag', 'added_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'LikeVideo.added_time'
        db.alter_column(u'catalog_likevideo', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ProductImage.added_time'
        db.alter_column(u'catalog_productimage', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'VoteShopReview.added_time'
        db.alter_column(u'catalog_voteshopreview', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'MakeyImage.added_time'
        db.alter_column(u'catalog_makeyimage', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'LikeCfiStoreItem.added_time'
        db.alter_column(u'catalog_likecfistoreitem', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Like.added_time'
        db.alter_column(u'catalog_like', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Article.added_time'
        db.alter_column(u'catalog_article', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'FavoriteMakey.added_time'
        db.alter_column(u'catalog_favoritemakey', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Product.added_time'
        db.alter_column(u'catalog_product', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'LikeShop.added_time'
        db.alter_column(u'catalog_likeshop', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Image.added_time'
        db.alter_column(u'catalog_image', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Tutorial.added_time'
        db.alter_column(u'catalog_tutorial', 'added_time', self.gf('django.db.models.fields.DateTimeField')())
        # Removing M2M table for field comments on 'Answer'
        db.delete_table(db.shorten_name(u'catalog_answer_comments'))


        # Changing field 'ArticleEmail.added_time'
        db.alter_column(u'catalog_articleemail', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'LikeImage.added_time'
        db.alter_column(u'catalog_likeimage', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'NewUser.added_time'
        db.alter_column(u'catalog_newuser', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'LikeListing.added_time'
        db.alter_column(u'catalog_likelisting', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'LikeNote.added_time'
        db.alter_column(u'catalog_likenote', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'VoteProductReview.added_time'
        db.alter_column(u'catalog_voteproductreview', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'LikeProductTutorial.added_time'
        db.alter_column(u'catalog_likeproducttutorial', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'InstructableStep.added_time'
        db.alter_column(u'catalog_instructablestep', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'LikeChannel.added_time'
        db.alter_column(u'catalog_likechannel', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ProductShopUrl.added_time'
        db.alter_column(u'catalog_productshopurl', 'added_time', self.gf('django.db.models.fields.DateTimeField')())
        # Removing M2M table for field comments on 'Question'
        db.delete_table(db.shorten_name(u'catalog_question_comments'))


        # Changing field 'UpFile.added_time'
        db.alter_column(u'catalog_upfile', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ListItem.added_time'
        db.alter_column(u'catalog_listitem', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Comment.added_time'
        db.alter_column(u'catalog_comment', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'UserProfile.added_time'
        db.alter_column(u'catalog_userprofile', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'List.added_time'
        db.alter_column(u'catalog_list', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ListGroup.added_time'
        db.alter_column(u'catalog_listgroup', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Documentation.added_time'
        db.alter_column(u'catalog_documentation', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Shop.added_time'
        db.alter_column(u'catalog_shop', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'CfiStoreItem.added_time'
        db.alter_column(u'catalog_cfistoreitem', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Note.added_time'
        db.alter_column(u'catalog_note', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Makey.added_time'
        db.alter_column(u'catalog_makey', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'UserFlags.added_time'
        db.alter_column(u'catalog_userflags', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'LikeProductImage.added_time'
        db.alter_column(u'catalog_likeproductimage', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'SpaceReview.added_time'
        db.alter_column(u'catalog_spacereview', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Location.added_time'
        db.alter_column(u'catalog_location', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'NewInventory.added_time'
        db.alter_column(u'catalog_newinventory', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'LikeArticle.added_time'
        db.alter_column(u'catalog_likearticle', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'LikeProductDescription.added_time'
        db.alter_column(u'catalog_likeproductdescription', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Listing.added_time'
        db.alter_column(u'catalog_listing', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'VoteMakey.added_time'
        db.alter_column(u'catalog_votemakey', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ProductReview.added_time'
        db.alter_column(u'catalog_productreview', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'LikeProduct.added_time'
        db.alter_column(u'catalog_likeproduct', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Video.added_time'
        db.alter_column(u'catalog_video', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'TopProducts.added_time'
        db.alter_column(u'catalog_topproducts', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'NewProduct.added_time'
        db.alter_column(u'catalog_newproduct', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'UserInteraction.added_time'
        db.alter_column(u'catalog_userinteraction', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'TopMakeys.added_time'
        db.alter_column(u'catalog_topmakeys', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'LikeMakey.added_time'
        db.alter_column(u'catalog_likemakey', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'TopTutorials.added_time'
        db.alter_column(u'catalog_toptutorials', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'VoteTutorial.added_time'
        db.alter_column(u'catalog_votetutorial', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'TopUsers.added_time'
        db.alter_column(u'catalog_topusers', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ShopReview.added_time'
        db.alter_column(u'catalog_shopreview', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'VoteSpaceReview.added_time'
        db.alter_column(u'catalog_votespacereview', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'TopShops.added_time'
        db.alter_column(u'catalog_topshops', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'TextDocumentation.added_time'
        db.alter_column(u'catalog_textdocumentation', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Space.added_time'
        db.alter_column(u'catalog_space', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'LikeComment.added_time'
        db.alter_column(u'catalog_likecomment', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ProductDescription.added_time'
        db.alter_column(u'catalog_productdescription', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Inventory.added_time'
        db.alter_column(u'catalog_inventory', 'added_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ArticleTag.added_time'
        db.alter_column(u'catalog_articletag', 'added_time', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'catalog.question': {
            ...
            'comments': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'question'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['catalog.Comment']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'description': ('tinymce.models.HTMLField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
