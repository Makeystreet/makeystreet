...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TextDocumentation.makey'
        db.add_column(u'catalog_textdocumentation', 'makey',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='text_documentations', null=True, to=orm['catalog.Makey']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TextDocumentation.makey'
        db.delete_column(u'catalog_textdocumentation', 'makey_id')
