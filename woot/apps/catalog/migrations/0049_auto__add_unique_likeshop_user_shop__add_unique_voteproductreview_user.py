...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'LikeShop', fields ['user', 'shop']
        db.create_unique(u'catalog_likeshop', ['user_id', 'shop_id'])

        # Adding unique constraint on 'VoteProductReview', fields ['user', 'review']
        db.create_unique(u'catalog_voteproductreview', ['user_id', 'review_id'])

        # Adding unique constraint on 'LikeProductTutorial', fields ['user', 'tutorial', 'product']
        db.create_unique(u'catalog_likeproducttutorial', ['user_id', 'tutorial_id', 'product_id'])

        # Adding unique constraint on 'LikeProductImage', fields ['user', 'image']
        db.create_unique(u'catalog_likeproductimage', ['user_id', 'image_id'])

        # Adding unique constraint on 'LikeProductDescription', fields ['user', 'product_description']
        db.create_unique(u'catalog_likeproductdescription', ['user_id', 'product_description_id'])

        # Adding unique constraint on 'LikeProduct', fields ['user', 'product']
        db.create_unique(u'catalog_likeproduct', ['user_id', 'product_id'])

        # Adding unique constraint on 'LikeMakey', fields ['user', 'makey']
        db.create_unique(u'catalog_likemakey', ['user_id', 'makey_id'])

        # Adding unique constraint on 'LikeCfiStoreItem', fields ['user', 'cfi_store_item']
        db.create_unique(u'catalog_likecfistoreitem', ['user_id', 'cfi_store_item_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'LikeCfiStoreItem', fields ['user', 'cfi_store_item']
        db.delete_unique(u'catalog_likecfistoreitem', ['user_id', 'cfi_store_item_id'])

        # Removing unique constraint on 'LikeMakey', fields ['user', 'makey']
        db.delete_unique(u'catalog_likemakey', ['user_id', 'makey_id'])

        # Removing unique constraint on 'LikeProduct', fields ['user', 'product']
        db.delete_unique(u'catalog_likeproduct', ['user_id', 'product_id'])

        # Removing unique constraint on 'LikeProductDescription', fields ['user', 'product_description']
        db.delete_unique(u'catalog_likeproductdescription', ['user_id', 'product_description_id'])

        # Removing unique constraint on 'LikeProductImage', fields ['user', 'image']
        db.delete_unique(u'catalog_likeproductimage', ['user_id', 'image_id'])

        # Removing unique constraint on 'LikeProductTutorial', fields ['user', 'tutorial', 'product']
        db.delete_unique(u'catalog_likeproducttutorial', ['user_id', 'tutorial_id', 'product_id'])

        # Removing unique constraint on 'VoteProductReview', fields ['user', 'review']
        db.delete_unique(u'catalog_voteproductreview', ['user_id', 'review_id'])

        # Removing unique constraint on 'LikeShop', fields ['user', 'shop']
        db.delete_unique(u'catalog_likeshop', ['user_id', 'shop_id'])
