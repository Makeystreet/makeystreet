...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InstructableStep'
        db.create_table(u'catalog_instructablestep', (
            ...
            ('iid', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ...
            ('words', self.gf('django.db.models.fields.IntegerField')()),
            ('makey', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Makey'])),
        ))
        db.send_create_signal('catalog', ['InstructableStep'])

        # Adding M2M table for field images on 'InstructableStep'
        m2m_table_name = db.shorten_name(u'catalog_instructablestep_images')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('instructablestep', models.ForeignKey(orm['catalog.instructablestep'], null=False)),
            ('image', models.ForeignKey(orm['catalog.image'], null=False))
        ))
        db.create_unique(m2m_table_name, ['instructablestep_id', 'image_id'])


    def backwards(self, orm):
        # Deleting model 'InstructableStep'
        db.delete_table(u'catalog_instructablestep')

        # Removing M2M table for field images on 'InstructableStep'
        db.delete_table(db.shorten_name(u'catalog_instructablestep_images'))
    ...
    models = {
        ...
        'catalog.instructablestep': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'iid': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
        ...
        'catalog.note': {
            'Meta': {'ordering': "['-id']", 'object_name': 'Note'},
            'added_time': ('django.db.models.fields.DateTimeField', [], {}),
            'body': ('django.db.models.fields.CharField', [], {'max_length': '1000'}),
            'comments': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['catalog.Comment']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
