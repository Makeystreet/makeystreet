...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FavoriteMakey'
        db.create_table(u'catalog_favoritemakey', (
        ...
        db.send_create_signal('catalog', ['FavoriteMakey'])

        # Adding unique constraint on 'FavoriteMakey', fields ['user', 'makey']
        db.create_unique(u'catalog_favoritemakey', ['user_id', 'makey_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'FavoriteMakey', fields ['user', 'makey']
        db.delete_unique(u'catalog_favoritemakey', ['user_id', 'makey_id'])

        # Deleting model 'FavoriteMakey'
        db.delete_table(u'catalog_favoritemakey')
