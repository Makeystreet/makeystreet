...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VoteProductReview'
        db.create_table(u'catalog_voteproductreview', (
            ...
            ('review', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.ProductReview'])),
        ))
        db.send_create_signal('catalog', ['VoteProductReview'])


    def backwards(self, orm):
        # Deleting model 'VoteProductReview'
        db.delete_table(u'catalog_voteproductreview')
    ...
    models = {
        ...
        'catalog.voteproductreview': {
            'Meta': {'object_name': 'VoteProductReview'},
            'added_time': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
