...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Note.body_txt'
        db.delete_column(u'catalog_note', 'body_txt')


        # Changing field 'Note.title'
        db.alter_column(u'catalog_note', 'title', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):
        # Adding field 'Note.body_txt'
        db.add_column(u'catalog_note', 'body_txt',
