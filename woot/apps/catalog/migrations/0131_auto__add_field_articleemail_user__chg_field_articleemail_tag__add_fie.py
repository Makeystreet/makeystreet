...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArticleEmail.user'
        db.add_column(u'catalog_articleemail', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'ArticleEmail.tag'
        db.alter_column(u'catalog_articleemail', 'tag_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['catalog.ArticleTag']))


    def backwards(self, orm):
        # Deleting field 'ArticleEmail.user'
        db.delete_column(u'catalog_articleemail', 'user_id')


        # Changing field 'ArticleEmail.tag'
        db.alter_column(u'catalog_articleemail', 'tag_id', self.gf('django.db.models.fields.related.ForeignKey')(default=3, to=orm['catalog.ArticleTag']))
