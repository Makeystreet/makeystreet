...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ShopReview'
        db.create_table(u'catalog_shopreview', (
            ...
            ('shop', self.gf('django.db.models.fields.related.ForeignKey')(related_name='shop_reviews', to=orm['catalog.Shop'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_facebook.FacebookCustomUser'])),
        ))
        db.send_create_signal('catalog', ['ShopReview'])


    def backwards(self, orm):
        # Deleting model 'ShopReview'
        db.delete_table(u'catalog_shopreview')
    ...
    models = {
        ...
        'catalog.productreview': {
            'Meta': {'object_name': 'ProductReview', '_ormbases': ['catalog.BaseModel']},
            u'basemodel_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['catalog.BaseModel']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        'catalog.shopreview': {
            'Meta': {'object_name': 'ShopReview', '_ormbases': ['catalog.BaseModel']},
            u'basemodel_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['catalog.BaseModel']", 'unique': 'True', 'primary_key': 'True'}),
            'review': ('django.db.models.fields.CharField', [], {'max_length': '100000'}),
