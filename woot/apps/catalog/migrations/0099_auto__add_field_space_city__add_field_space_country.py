...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Space.city'
        db.add_column(u'catalog_space', 'city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Space.country'
        db.add_column(u'catalog_space', 'country',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Space.city'
        db.delete_column(u'catalog_space', 'city')

        # Deleting field 'Space.country'
        db.delete_column(u'catalog_space', 'country')
