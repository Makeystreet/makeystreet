...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InstructableStep.url'
        db.alter_column(u'catalog_instructablestep', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'InstructableStep.iid'
        db.alter_column(u'catalog_instructablestep', 'iid', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'InstructableStep.url'
        db.alter_column(u'catalog_instructablestep', 'url', self.gf('django.db.models.fields.URLField')(default=None, max_length=200))

        # Changing field 'InstructableStep.iid'
        db.alter_column(u'catalog_instructablestep', 'iid', self.gf('django.db.models.fields.CharField')(default=None, max_length=50))
