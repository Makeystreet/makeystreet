...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'catalog_collection', (
        ...
        db.send_create_signal('catalog', ['Collection'])

        # Adding M2M table for field makeys on 'Collection'
        m2m_table_name = db.shorten_name(u'catalog_collection_makeys')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('collection', models.ForeignKey(orm['catalog.collection'], null=False)),
            ('makey', models.ForeignKey(orm['catalog.makey'], null=False))
        ))
        db.create_unique(m2m_table_name, ['collection_id', 'makey_id'])


    def backwards(self, orm):
        # Deleting model 'Collection'
        db.delete_table(u'catalog_collection')

        # Removing M2M table for field makeys on 'Collection'
        db.delete_table(db.shorten_name(u'catalog_collection_makeys'))
    ...
    models = {
        ...
        'catalog.upfile': {
            ...
            'filetype': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
