...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field space_as_tools on 'Product'
        m2m_table_name = db.shorten_name(u'catalog_product_space_as_tools')
        ...
        db.create_unique(m2m_table_name, ['product_id', 'space_id'])

        # Adding field 'Makey.made_in'
        db.add_column(u'catalog_makey', 'made_in',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='makeys_made_in', null=True, to=orm['catalog.Space']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Removing M2M table for field space_as_tools on 'Product'
        db.delete_table(db.shorten_name(u'catalog_product_space_as_tools'))

        # Deleting field 'Makey.made_in'
        db.delete_column(u'catalog_makey', 'made_in_id')
