...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Space.map_zoom_level'
        db.add_column(u'catalog_space', 'map_zoom_level',
                      self.gf('django.db.models.fields.IntegerField')(default=13),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Space.map_zoom_level'
        db.delete_column(u'catalog_space', 'map_zoom_level')
