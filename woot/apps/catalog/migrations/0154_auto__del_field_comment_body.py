...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'catalog_comment', 'body')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Comment.body'
        raise RuntimeError("Cannot reverse this migration. 'Comment.body' and its values cannot be restored.")
