...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VoteSpaceReview'
        db.create_table(u'catalog_votespacereview', (
            ...
            ('review', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.SpaceReview'])),
        ))
        db.send_create_signal('catalog', ['VoteSpaceReview'])

        # Adding unique constraint on 'VoteSpaceReview', fields ['user', 'review']
        db.create_unique(u'catalog_votespacereview', ['user_id', 'review_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'VoteSpaceReview', fields ['user', 'review']
        db.delete_unique(u'catalog_votespacereview', ['user_id', 'review_id'])

        # Deleting model 'VoteSpaceReview'
        db.delete_table(u'catalog_votespacereview')
