...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field comments on 'Image'
        m2m_table_name = db.shorten_name(u'catalog_image_comments')
        ...
        db.create_unique(m2m_table_name, ['image_id', 'comment_id'])


    def backwards(self, orm):
        # Removing M2M table for field comments on 'Image'
        db.delete_table(db.shorten_name(u'catalog_image_comments'))
