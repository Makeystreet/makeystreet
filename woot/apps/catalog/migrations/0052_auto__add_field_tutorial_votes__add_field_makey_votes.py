...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tutorial.votes'
        db.add_column(u'catalog_tutorial', 'votes',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Makey.votes'
        db.add_column(u'catalog_makey', 'votes',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tutorial.votes'
        db.delete_column(u'catalog_tutorial', 'votes')

        # Deleting field 'Makey.votes'
        db.delete_column(u'catalog_makey', 'votes')
