...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Space.longitude'
        db.alter_column(u'catalog_space', 'longitude', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=10))

        # Changing field 'Space.latitude'
        db.alter_column(u'catalog_space', 'latitude', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=10))

    def backwards(self, orm):

        # Changing field 'Space.longitude'
        db.alter_column(u'catalog_space', 'longitude', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Space.latitude'
        db.alter_column(u'catalog_space', 'latitude', self.gf('django.db.models.fields.IntegerField')(null=True))
