...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Tutorial.user'
        db.alter_column(u'catalog_tutorial', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['django_facebook.FacebookCustomUser']))

        # Changing field 'Tutorial.description'
        db.alter_column(u'catalog_tutorial', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
