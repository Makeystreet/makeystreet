...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'catalog_likevideo', 'fb_like_id',
                      self.gf('django.db.models.fields.CharField')(default='-1', max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LikeShop.fb_like_id'
        db.add_column(u'catalog_likeshop', 'fb_like_id',
                      self.gf('django.db.models.fields.CharField')(default='-1', max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LikeImage.fb_like_id'
        db.add_column(u'catalog_likeimage', 'fb_like_id',
                      self.gf('django.db.models.fields.CharField')(default='-1', max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LikeProductTutorial.fb_like_id'
        db.add_column(u'catalog_likeproducttutorial', 'fb_like_id',
                      self.gf('django.db.models.fields.CharField')(default='-1', max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LikeProductImage.fb_like_id'
        db.add_column(u'catalog_likeproductimage', 'fb_like_id',
                      self.gf('django.db.models.fields.CharField')(default='-1', max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LikeArticle.fb_like_id'
        db.add_column(u'catalog_likearticle', 'fb_like_id',
                      self.gf('django.db.models.fields.CharField')(default='-1', max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LikeProductDescription.fb_like_id'
        db.add_column(u'catalog_likeproductdescription', 'fb_like_id',
                      self.gf('django.db.models.fields.CharField')(default='-1', max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LikeProduct.fb_like_id'
        db.add_column(u'catalog_likeproduct', 'fb_like_id',
                      self.gf('django.db.models.fields.CharField')(default='-1', max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LikeMakey.fb_like_id'
        db.add_column(u'catalog_likemakey', 'fb_like_id',
                      self.gf('django.db.models.fields.CharField')(default='-1', max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LikeNote.fb_like_id'
        db.add_column(u'catalog_likenote', 'fb_like_id',
                      self.gf('django.db.models.fields.CharField')(default='-1', max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LikeCfiStoreItem.fb_like_id'
        db.add_column(u'catalog_likecfistoreitem', 'fb_like_id',
                      self.gf('django.db.models.fields.CharField')(default='-1', max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LikeComment.fb_like_id'
        db.add_column(u'catalog_likecomment', 'fb_like_id',
                      self.gf('django.db.models.fields.CharField')(default='-1', max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LikeVideo.fb_like_id'
        db.delete_column(u'catalog_likevideo', 'fb_like_id')

        # Deleting field 'LikeShop.fb_like_id'
        db.delete_column(u'catalog_likeshop', 'fb_like_id')

        # Deleting field 'LikeImage.fb_like_id'
        db.delete_column(u'catalog_likeimage', 'fb_like_id')

        # Deleting field 'LikeProductTutorial.fb_like_id'
        db.delete_column(u'catalog_likeproducttutorial', 'fb_like_id')

        # Deleting field 'LikeProductImage.fb_like_id'
        db.delete_column(u'catalog_likeproductimage', 'fb_like_id')

        # Deleting field 'LikeArticle.fb_like_id'
        db.delete_column(u'catalog_likearticle', 'fb_like_id')

        # Deleting field 'LikeProductDescription.fb_like_id'
        db.delete_column(u'catalog_likeproductdescription', 'fb_like_id')

        # Deleting field 'LikeProduct.fb_like_id'
        db.delete_column(u'catalog_likeproduct', 'fb_like_id')

        # Deleting field 'LikeMakey.fb_like_id'
        db.delete_column(u'catalog_likemakey', 'fb_like_id')

        # Deleting field 'LikeNote.fb_like_id'
        db.delete_column(u'catalog_likenote', 'fb_like_id')

        # Deleting field 'LikeCfiStoreItem.fb_like_id'
        db.delete_column(u'catalog_likecfistoreitem', 'fb_like_id')

        # Deleting field 'LikeComment.fb_like_id'
        db.delete_column(u'catalog_likecomment', 'fb_like_id')
