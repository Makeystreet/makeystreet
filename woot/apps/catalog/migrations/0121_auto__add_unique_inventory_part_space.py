...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Inventory', fields ['part', 'space']
        db.create_unique(u'catalog_inventory', ['part_id', 'space_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Inventory', fields ['part', 'space']
        db.delete_unique(u'catalog_inventory', ['part_id', 'space_id'])
