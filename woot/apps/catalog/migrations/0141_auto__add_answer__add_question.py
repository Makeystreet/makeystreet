...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Answer'
        db.create_table(u'catalog_answer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('description', self.gf('tinymce.models.HTMLField')()),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Question'])),
        ...
        db.send_create_signal('catalog', ['Answer'])

        # Adding model 'Question'
        db.create_table(u'catalog_question', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('accepted_answer', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='answer_of', null=True, blank=True, to=orm['catalog.Answer'])),
            ('accepted_time', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('makey', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Makey'])),
        ))
        db.send_create_signal('catalog', ['Question'])


    def backwards(self, orm):
        # Deleting model 'Answer'
        db.delete_table(u'catalog_answer')

        # Deleting model 'Question'
        db.delete_table(u'catalog_question')
    ...
    models = {
        ...
        'catalog.question': {
            ...
            'accepted_time': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
