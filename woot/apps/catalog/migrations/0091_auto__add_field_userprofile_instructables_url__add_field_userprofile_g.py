...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.instructables_url'
        db.add_column(u'catalog_userprofile', 'instructables_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=1000),
                      keep_default=False)

        # Adding field 'UserProfile.github_url'
        db.add_column(u'catalog_userprofile', 'github_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=1000),
                      keep_default=False)

        # Adding field 'UserProfile.linkedin_url'
        db.add_column(u'catalog_userprofile', 'linkedin_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=1000),
                      keep_default=False)

        # Adding field 'UserProfile.facebook_url'
        db.add_column(u'catalog_userprofile', 'facebook_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=1000),
                      keep_default=False)

        # Adding field 'UserProfile.twitter_url'
        db.add_column(u'catalog_userprofile', 'twitter_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=1000),
                      keep_default=False)

        # Adding field 'UserProfile.yt_channel_url'
        db.add_column(u'catalog_userprofile', 'yt_channel_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=1000),
                      keep_default=False)

        # Adding field 'UserProfile.stackoverflow_url'
        db.add_column(u'catalog_userprofile', 'stackoverflow_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=1000),
                      keep_default=False)

        # Adding field 'UserProfile.blog_url'
        db.add_column(u'catalog_userprofile', 'blog_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=1000),
                      keep_default=False)

        # Adding field 'UserProfile.website_url'
        db.add_column(u'catalog_userprofile', 'website_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=1000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.instructables_url'
        db.delete_column(u'catalog_userprofile', 'instructables_url')

        # Deleting field 'UserProfile.github_url'
        db.delete_column(u'catalog_userprofile', 'github_url')

        # Deleting field 'UserProfile.linkedin_url'
        db.delete_column(u'catalog_userprofile', 'linkedin_url')

        # Deleting field 'UserProfile.facebook_url'
        db.delete_column(u'catalog_userprofile', 'facebook_url')

        # Deleting field 'UserProfile.twitter_url'
        db.delete_column(u'catalog_userprofile', 'twitter_url')

        # Deleting field 'UserProfile.yt_channel_url'
        db.delete_column(u'catalog_userprofile', 'yt_channel_url')

        # Deleting field 'UserProfile.stackoverflow_url'
        db.delete_column(u'catalog_userprofile', 'stackoverflow_url')

        # Deleting field 'UserProfile.blog_url'
        db.delete_column(u'catalog_userprofile', 'blog_url')

        # Deleting field 'UserProfile.website_url'
        db.delete_column(u'catalog_userprofile', 'website_url')
    ...
    models = {
        ...
        'catalog.userprofile': {
            ...
            'added_time': ('django.db.models.fields.DateTimeField', [], {}),
            'blog_url': ('django.db.models.fields.URLField', [], {'max_length': '1000'}),
            'facebook_url': ('django.db.models.fields.URLField', [], {'max_length': '1000'}),
            ...
            'github_url': ('django.db.models.fields.URLField', [], {'max_length': '1000'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instructables_url': ('django.db.models.fields.URLField', [], {'max_length': '1000'}),
            'is_enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'linkedin_url': ('django.db.models.fields.URLField', [], {'max_length': '1000'}),
            'score': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'stackoverflow_url': ('django.db.models.fields.URLField', [], {'max_length': '1000'}),
            'twitter_url': ('django.db.models.fields.URLField', [], {'max_length': '1000'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'profile'", 'unique': 'True', 'to': u"orm['auth.User']"}),
            'website_url': ('django.db.models.fields.URLField', [], {'max_length': '1000'}),
            'yt_channel_url': ('django.db.models.fields.URLField', [], {'max_length': '1000'})
        },
        'catalog.video': {
