...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LikeComment'
        db.create_table(u'catalog_likecomment', (
            ...
            ('comment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Comment'])),
        ))
        db.send_create_signal('catalog', ['LikeComment'])

        # Adding unique constraint on 'LikeComment', fields ['user', 'comment']
        db.create_unique(u'catalog_likecomment', ['user_id', 'comment_id'])

        # Adding field 'Comment.likes_count'
        db.add_column(u'catalog_comment', 'likes_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'LikeComment', fields ['user', 'comment']
        db.delete_unique(u'catalog_likecomment', ['user_id', 'comment_id'])

        # Deleting model 'LikeComment'
        db.delete_table(u'catalog_likecomment')

        # Deleting field 'Comment.likes_count'
        db.delete_column(u'catalog_comment', 'likes_count')
