...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'catalog_inventory', (
            ...
            ('part', self.gf('django.db.models.fields.related.ForeignKey')(related_name='inventory_part', to=orm['catalog.Product'])),
            ('space', self.gf('django.db.models.fields.related.ForeignKey')(related_name='inventory_space', to=orm['catalog.Space'])),
            ('quantity', self.gf('django.db.models.fields.IntegerField')(default=1, null=True, blank=True)),
        ))
        db.send_create_signal('catalog', ['Inventory'])


    def backwards(self, orm):
        # Deleting model 'Inventory'
        db.delete_table(u'catalog_inventory')
