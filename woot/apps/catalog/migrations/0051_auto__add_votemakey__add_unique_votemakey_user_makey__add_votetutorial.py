...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VoteMakey'
        db.create_table(u'catalog_votemakey', (
        ...
        db.send_create_signal('catalog', ['VoteMakey'])

        # Adding unique constraint on 'VoteMakey', fields ['user', 'makey']
        db.create_unique(u'catalog_votemakey', ['user_id', 'makey_id'])

        # Adding model 'VoteTutorial'
        db.create_table(u'catalog_votetutorial', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('added_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('is_enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('score', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.send_create_signal('catalog', ['VoteTutorial'])

        # Adding unique constraint on 'VoteTutorial', fields ['user', 'tutorial']
        db.create_unique(u'catalog_votetutorial', ['user_id', 'tutorial_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'VoteTutorial', fields ['user', 'tutorial']
        db.delete_unique(u'catalog_votetutorial', ['user_id', 'tutorial_id'])

        # Removing unique constraint on 'VoteMakey', fields ['user', 'makey']
        db.delete_unique(u'catalog_votemakey', ['user_id', 'makey_id'])

        # Deleting model 'VoteMakey'
        db.delete_table(u'catalog_votemakey')

        # Deleting model 'VoteTutorial'
        db.delete_table(u'catalog_votetutorial')
