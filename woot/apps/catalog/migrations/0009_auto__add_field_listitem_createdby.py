...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ListItem.createdby'
        db.add_column(u'catalog_listitem', 'createdby',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['django_facebook.FacebookCustomUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ListItem.createdby'
        db.delete_column(u'catalog_listitem', 'createdby_id')
