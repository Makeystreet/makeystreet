...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArticleEmail.temp_id'
        db.add_column(u'catalog_articleemail', 'temp_id',
                      self.gf('django.db.models.fields.CharField')(default=-1, max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArticleEmail.temp_id'
        db.delete_column(u'catalog_articleemail', 'temp_id')
