...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'catalog_bom', (
            ...
            ('makey', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bom', to=orm['catalog.Makey'])),
            ('comments', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('catalog', ['BOM'])


    def backwards(self, orm):
        # Deleting model 'BOM'
        db.delete_table(u'catalog_bom')
