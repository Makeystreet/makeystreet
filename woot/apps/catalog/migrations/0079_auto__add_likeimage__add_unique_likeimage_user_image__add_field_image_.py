...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LikeImage'
        db.create_table(u'catalog_likeimage', (
            ...
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Image'])),
        ))
        db.send_create_signal('catalog', ['LikeImage'])

        # Adding unique constraint on 'LikeImage', fields ['user', 'image']
        db.create_unique(u'catalog_likeimage', ['user_id', 'image_id'])

        # Adding field 'Image.likes_count'
        db.add_column(u'catalog_image', 'likes_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'LikeImage', fields ['user', 'image']
        db.delete_unique(u'catalog_likeimage', ['user_id', 'image_id'])

        # Deleting model 'LikeImage'
        db.delete_table(u'catalog_likeimage')

        # Deleting field 'Image.likes_count'
        db.delete_column(u'catalog_image', 'likes_count')
