...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Space.city'
        db.alter_column(u'catalog_space', 'city', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Space.kind'
        db.alter_column(u'catalog_space', 'kind', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Space.country'
        db.alter_column(u'catalog_space', 'country', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Space.city'
        db.alter_column(u'catalog_space', 'city', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Space.kind'
        db.alter_column(u'catalog_space', 'kind', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Space.country'
        db.alter_column(u'catalog_space', 'country', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
