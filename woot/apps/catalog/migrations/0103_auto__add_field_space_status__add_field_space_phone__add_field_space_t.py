...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Space.status'
        db.add_column(u'catalog_space', 'status',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Space.phone'
        db.add_column(u'catalog_space', 'phone',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Space.twitter'
        db.add_column(u'catalog_space', 'twitter',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Space.facebook'
        db.add_column(u'catalog_space', 'facebook',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Space.no_of_members'
        db.add_column(u'catalog_space', 'no_of_members',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Space.membership_fee'
        db.add_column(u'catalog_space', 'membership_fee',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Space.date_of_founding'
        db.add_column(u'catalog_space', 'date_of_founding',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Space.last_updated_external'
        db.add_column(u'catalog_space', 'last_updated_external',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Space.status'
        db.delete_column(u'catalog_space', 'status')

        # Deleting field 'Space.phone'
        db.delete_column(u'catalog_space', 'phone')

        # Deleting field 'Space.twitter'
        db.delete_column(u'catalog_space', 'twitter')

        # Deleting field 'Space.facebook'
        db.delete_column(u'catalog_space', 'facebook')

        # Deleting field 'Space.no_of_members'
        db.delete_column(u'catalog_space', 'no_of_members')

        # Deleting field 'Space.membership_fee'
        db.delete_column(u'catalog_space', 'membership_fee')

        # Deleting field 'Space.date_of_founding'
        db.delete_column(u'catalog_space', 'date_of_founding')

        # Deleting field 'Space.last_updated_external'
        db.delete_column(u'catalog_space', 'last_updated_external')
