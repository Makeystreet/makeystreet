...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductDescription.description'
        db.alter_column(u'catalog_productdescription', 'description', self.gf('django.db.models.fields.CharField')(max_length=100000))

    def backwards(self, orm):

        # Changing field 'ProductDescription.description'
        db.alter_column(u'catalog_productdescription', 'description', self.gf('django.db.models.fields.CharField')(max_length=10000))
