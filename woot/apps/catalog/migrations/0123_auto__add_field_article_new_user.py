...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.new_user'
        db.add_column(u'catalog_article', 'new_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.NewUser'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.new_user'
        db.delete_column(u'catalog_article', 'new_user_id')
