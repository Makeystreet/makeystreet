...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Makey', fields ['user', 'slug']
        db.create_unique(u'catalog_makey', ['user_id', 'slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Makey', fields ['user', 'slug']
        db.delete_unique(u'catalog_makey', ['user_id', 'slug'])
