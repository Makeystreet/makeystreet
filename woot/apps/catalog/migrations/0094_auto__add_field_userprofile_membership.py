...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.membership'
        db.add_column(u'catalog_userprofile', 'membership',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.membership'
        db.delete_column(u'catalog_userprofile', 'membership')
