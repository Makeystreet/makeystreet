...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Makey.status'
        db.add_column(u'catalog_makey', 'status',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Makey.why'
        db.add_column(u'catalog_makey', 'why',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Makey.status'
        db.delete_column(u'catalog_makey', 'status')

        # Deleting field 'Makey.why'
        db.delete_column(u'catalog_makey', 'why')
