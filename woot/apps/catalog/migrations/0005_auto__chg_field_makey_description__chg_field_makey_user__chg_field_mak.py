...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Makey.description'
        db.alter_column(u'catalog_makey', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Makey.user'
        db.alter_column(u'catalog_makey', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['django_facebook.FacebookCustomUser']))

        # Changing field 'Makey.name'
        db.alter_column(u'catalog_makey', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
