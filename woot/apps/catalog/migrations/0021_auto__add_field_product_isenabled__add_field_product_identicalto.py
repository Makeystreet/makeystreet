...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.identicalto'
        db.add_column(u'catalog_product', 'identicalto',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Product.identicalto'
        db.delete_column(u'catalog_product', 'identicalto_id')
