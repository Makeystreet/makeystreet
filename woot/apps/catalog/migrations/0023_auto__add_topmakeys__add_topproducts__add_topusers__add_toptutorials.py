...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TopMakeys'
        db.create_table(u'catalog_topmakeys', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('makey', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Makey'])),
            ('score', self.gf('django.db.models.fields.IntegerField')()),
            ('time', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'catalog', ['TopMakeys'])

        # Adding model 'TopProducts'
        db.create_table(u'catalog_topproducts', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Product'])),
            ('score', self.gf('django.db.models.fields.IntegerField')()),
            ('time', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'catalog', ['TopProducts'])

        # Adding model 'TopUsers'
        db.create_table(u'catalog_topusers', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_facebook.FacebookCustomUser'])),
            ('score', self.gf('django.db.models.fields.IntegerField')()),
            ('time', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'catalog', ['TopUsers'])

        # Adding model 'TopTutorials'
        db.create_table(u'catalog_toptutorials', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tutorial', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Tutorial'])),
            ('score', self.gf('django.db.models.fields.IntegerField')()),
            ('time', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'catalog', ['TopTutorials'])


    def backwards(self, orm):
        # Deleting model 'TopMakeys'
        db.delete_table(u'catalog_topmakeys')

        # Deleting model 'TopProducts'
        db.delete_table(u'catalog_topproducts')

        # Deleting model 'TopUsers'
        db.delete_table(u'catalog_topusers')

        # Deleting model 'TopTutorials'
        db.delete_table(u'catalog_toptutorials')
    ...
    models = {
        ...
        u'catalog.product': {
            ...
            'isenabled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
