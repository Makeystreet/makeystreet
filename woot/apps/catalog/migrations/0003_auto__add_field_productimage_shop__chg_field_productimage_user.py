...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductImage.shop'
        db.add_column(u'catalog_productimage', 'shop',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Shop'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'ProductImage.shop'
        db.delete_column(u'catalog_productimage', 'shop_id')


        # Changing field 'ProductImage.user'
        db.alter_column(u'catalog_productimage', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['django_facebook.FacebookCustomUser']))
