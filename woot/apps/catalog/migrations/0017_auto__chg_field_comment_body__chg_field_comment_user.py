...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Comment.body'
        db.alter_column(u'catalog_comment', 'body', self.gf('django.db.models.fields.CharField')(default='', max_length=1000))

        # Changing field 'Comment.user'
        db.alter_column(u'catalog_comment', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['django_facebook.FacebookCustomUser']))

    def backwards(self, orm):

        # Changing field 'Comment.body'
        db.alter_column(u'catalog_comment', 'body', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Changing field 'Comment.user'
        db.alter_column(u'catalog_comment', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_facebook.FacebookCustomUser'], null=True))
