...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field new_tools on 'Makey'
        m2m_table_name = db.shorten_name(u'catalog_makey_new_tools')
        ...
        db.create_unique(m2m_table_name, ['makey_id', 'newproduct_id'])


    def backwards(self, orm):
        # Removing M2M table for field new_tools on 'Makey'
        db.delete_table(db.shorten_name(u'catalog_makey_new_tools'))
    ...
    models = {
        ...
        'catalog.userprofile': {
            ...
            'added_time': ('django.db.models.fields.DateTimeField', [], {}),
            'following': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'followers'", 'symmetrical': 'False', 'to': "orm['catalog.UserProfile']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'score': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
