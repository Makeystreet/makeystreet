...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LikeChannel'
        db.create_table(u'catalog_likechannel', (
            ...
            ('channel', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.ArticleTag'])),
        ))
        db.send_create_signal('catalog', ['LikeChannel'])

        # Adding unique constraint on 'LikeChannel', fields ['user', 'channel']
        db.create_unique(u'catalog_likechannel', ['user_id', 'channel_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'LikeChannel', fields ['user', 'channel']
        db.delete_unique(u'catalog_likechannel', ['user_id', 'channel_id'])

        # Deleting model 'LikeChannel'
        db.delete_table(u'catalog_likechannel')
