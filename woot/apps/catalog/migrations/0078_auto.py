...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field comments on 'Video'
        m2m_table_name = db.shorten_name(u'catalog_video_comments')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('video', models.ForeignKey(orm['catalog.video'], null=False)),
            ('comment', models.ForeignKey(orm['catalog.comment'], null=False))
        ))
        db.create_unique(m2m_table_name, ['video_id', 'comment_id'])


    def backwards(self, orm):
        # Removing M2M table for field comments on 'Video'
        db.delete_table(db.shorten_name(u'catalog_video_comments'))
