...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VoteShopReview'
        db.create_table(u'catalog_voteshopreview', (
            ...
            ('review', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.ShopReview'])),
        ))
        db.send_create_signal('catalog', ['VoteShopReview'])

        # Adding unique constraint on 'VoteShopReview', fields ['user', 'review']
        db.create_unique(u'catalog_voteshopreview', ['user_id', 'review_id'])

        # Adding field 'ShopReview.votes'
        db.add_column(u'catalog_shopreview', 'votes',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'VoteShopReview', fields ['user', 'review']
        db.delete_unique(u'catalog_voteshopreview', ['user_id', 'review_id'])

        # Deleting model 'VoteShopReview'
        db.delete_table(u'catalog_voteshopreview')

        # Deleting field 'ShopReview.votes'
        db.delete_column(u'catalog_shopreview', 'votes')
