...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ArticleEmail'
        db.create_table(u'catalog_articleemail', (
            ...
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name='email_subscriptions', to=orm['catalog.ArticleTag'])),
        ))
        db.send_create_signal('catalog', ['ArticleEmail'])


    def backwards(self, orm):
        # Deleting model 'ArticleEmail'
        db.delete_table(u'catalog_articleemail')
