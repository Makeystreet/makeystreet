...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.execute('ALTER TABLE "catalog_emailcollect" ADD COLUMN "id" SERIAL NOT NULL PRIMARY KEY')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'EmailCollect.basemodel_ptr'
        raise RuntimeError("Cannot reverse this migration. 'EmailCollect.basemodel_ptr' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'EmailCollect.basemodel_ptr'
