...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Note.is_pending_approval'
        db.add_column(u'catalog_note', 'is_pending_approval',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Note.is_pending_approval'
        db.delete_column(u'catalog_note', 'is_pending_approval')
