...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'catalog_upfile', 'filetype', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'UpFile.filetype'
        db.alter_column(u'catalog_upfile', 'filetype', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
