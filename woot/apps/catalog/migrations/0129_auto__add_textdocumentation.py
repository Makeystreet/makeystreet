...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TextDocumentation'
        db.create_table(u'catalog_textdocumentation', (
        ...
        db.send_create_signal('catalog', ['TextDocumentation'])


    def backwards(self, orm):
        # Deleting model 'TextDocumentation'
        db.delete_table(u'catalog_textdocumentation')
