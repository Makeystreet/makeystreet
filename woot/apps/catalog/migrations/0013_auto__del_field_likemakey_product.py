...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LikeMakey.product'
        db.delete_column(u'catalog_likemakey', 'product_id')


    def backwards(self, orm):
        # Adding field 'LikeMakey.product'
        db.add_column(u'catalog_likemakey', 'product',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['catalog.Product']),
                      keep_default=False)
