...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ToIndexStore'
        db.create_table(u'catalog_toindexstore', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Location'])),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('added_time', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'catalog', ['ToIndexStore'])

        # Adding model 'Location'
        db.create_table(u'catalog_location', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'catalog', ['Location'])


    def backwards(self, orm):
        # Deleting model 'ToIndexStore'
        db.delete_table(u'catalog_toindexstore')

        # Deleting model 'Location'
        db.delete_table(u'catalog_location')
