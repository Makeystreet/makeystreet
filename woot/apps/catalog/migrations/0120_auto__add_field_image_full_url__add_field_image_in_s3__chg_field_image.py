...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Image.full_url'
        db.add_column(u'catalog_image', 'full_url',
                      self.gf('django.db.models.fields.URLField')(max_length=1000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Image.in_s3'
        db.add_column(u'catalog_image', 'in_s3',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Image.large_url'
        db.alter_column(u'catalog_image', 'large_url', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))

    def backwards(self, orm):
        # Deleting field 'Image.full_url'
        db.delete_column(u'catalog_image', 'full_url')

        # Deleting field 'Image.in_s3'
        db.delete_column(u'catalog_image', 'in_s3')


        # Changing field 'Image.large_url'
        db.alter_column(u'catalog_image', 'large_url', self.gf('django.db.models.fields.URLField')(default='http://www.google.com', max_length=1000))
