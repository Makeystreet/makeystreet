...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Makey.as_part_new'
        db.add_column(u'catalog_makey', 'as_part_new',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='as_makey', null=True, to=orm['catalog.NewProduct']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Makey.as_part_new'
        db.delete_column(u'catalog_makey', 'as_part_new_id')
