...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TextDocumentation.title'
        db.alter_column(u'catalog_textdocumentation', 'title', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'TextDocumentation.title'
        db.alter_column(u'catalog_textdocumentation', 'title', self.gf('django.db.models.fields.TextField')(default='', max_length=100))
