...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field images on 'TextDocumentation'
        m2m_table_name = db.shorten_name(u'catalog_textdocumentation_images')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('textdocumentation', models.ForeignKey(orm['catalog.textdocumentation'], null=False)),
            ('image', models.ForeignKey(orm['catalog.image'], null=False))
        ))
        db.create_unique(m2m_table_name, ['textdocumentation_id', 'image_id'])


    def backwards(self, orm):
        # Removing M2M table for field images on 'TextDocumentation'
        db.delete_table(db.shorten_name(u'catalog_textdocumentation_images'))
