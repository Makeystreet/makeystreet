...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.execute('ALTER TABLE "catalog_searchlog" ADD COLUMN "id" SERIAL NOT NULL PRIMARY KEY')
...
#                       keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'SearchLog.basemodel_ptr'
        raise RuntimeError("Cannot reverse this migration. 'SearchLog.basemodel_ptr' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'SearchLog.basemodel_ptr'
