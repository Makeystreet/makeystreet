...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'catalog_likevideo', (
            ...
            ('video', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Video'])),
        ))
        db.send_create_signal('catalog', ['LikeVideo'])

        # Adding unique constraint on 'LikeVideo', fields ['user', 'video']
        db.create_unique(u'catalog_likevideo', ['user_id', 'video_id'])

        # Adding field 'Video.likes_count'
        db.add_column(u'catalog_video', 'likes_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'LikeVideo', fields ['user', 'video']
        db.delete_unique(u'catalog_likevideo', ['user_id', 'video_id'])

        # Deleting model 'LikeVideo'
        db.delete_table(u'catalog_likevideo')

        # Deleting field 'Video.likes_count'
        db.delete_column(u'catalog_video', 'likes_count')
