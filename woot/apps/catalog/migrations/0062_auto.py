...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field videos on 'Makey'
        m2m_table_name = db.shorten_name(u'catalog_makey_videos')
        ...
        db.create_unique(m2m_table_name, ['makey_id', 'video_id'])


    def backwards(self, orm):
        # Removing M2M table for field videos on 'Makey'
        db.delete_table(db.shorten_name(u'catalog_makey_videos'))
