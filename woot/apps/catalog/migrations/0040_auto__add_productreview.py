...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'catalog_productreview', (
            ...
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='product_reviews', to=orm['catalog.Product'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_facebook.FacebookCustomUser'])),
        ))
        db.send_create_signal('catalog', ['ProductReview'])


    def backwards(self, orm):
        # Deleting model 'ProductReview'
        db.delete_table(u'catalog_productreview')
