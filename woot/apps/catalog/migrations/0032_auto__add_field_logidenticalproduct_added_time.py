...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LogIdenticalProduct.added_time'
        db.add_column(u'catalog_logidenticalproduct', 'added_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 2, 20, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LogIdenticalProduct.added_time'
        db.delete_column(u'catalog_logidenticalproduct', 'added_time')
