...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.is_staff_pick'
        db.add_column(u'catalog_article', 'is_staff_pick',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Article.added_time_staff_pick'
        db.add_column(u'catalog_article', 'added_time_staff_pick',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.is_staff_pick'
        db.delete_column(u'catalog_article', 'is_staff_pick')

        # Deleting field 'Article.added_time_staff_pick'
        db.delete_column(u'catalog_article', 'added_time_staff_pick')
