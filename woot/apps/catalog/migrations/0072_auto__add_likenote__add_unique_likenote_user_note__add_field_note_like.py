...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LikeNote'
        db.create_table(u'catalog_likenote', (
            ...
            ('note', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Note'])),
        ))
        db.send_create_signal('catalog', ['LikeNote'])

        # Adding unique constraint on 'LikeNote', fields ['user', 'note']
        db.create_unique(u'catalog_likenote', ['user_id', 'note_id'])

        # Adding field 'Note.likes_count'
        db.add_column(u'catalog_note', 'likes_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'LikeNote', fields ['user', 'note']
        db.delete_unique(u'catalog_likenote', ['user_id', 'note_id'])

        # Deleting model 'LikeNote'
        db.delete_table(u'catalog_likenote')

        # Deleting field 'Note.likes_count'
        db.delete_column(u'catalog_note', 'likes_count')
