...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'catalog_shop', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['catalog.Location']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Shop.location'
        db.delete_column(u'catalog_shop', 'location_id')
