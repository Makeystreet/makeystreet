...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArticleTag.likes_count'
        db.add_column(u'catalog_articletag', 'likes_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArticleTag.likes_count'
        db.delete_column(u'catalog_articletag', 'likes_count')
