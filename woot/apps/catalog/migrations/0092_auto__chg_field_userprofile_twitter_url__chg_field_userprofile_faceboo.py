...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.twitter_url'
        db.alter_column(u'catalog_userprofile', 'twitter_url', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))

        # Changing field 'UserProfile.facebook_url'
        db.alter_column(u'catalog_userprofile', 'facebook_url', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))

        # Changing field 'UserProfile.linkedin_url'
        db.alter_column(u'catalog_userprofile', 'linkedin_url', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))

        # Changing field 'UserProfile.instructables_url'
        db.alter_column(u'catalog_userprofile', 'instructables_url', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))

        # Changing field 'UserProfile.github_url'
        db.alter_column(u'catalog_userprofile', 'github_url', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))

        # Changing field 'UserProfile.blog_url'
        db.alter_column(u'catalog_userprofile', 'blog_url', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))

        # Changing field 'UserProfile.stackoverflow_url'
        db.alter_column(u'catalog_userprofile', 'stackoverflow_url', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))

        # Changing field 'UserProfile.website_url'
        db.alter_column(u'catalog_userprofile', 'website_url', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))

        # Changing field 'UserProfile.yt_channel_url'
        db.alter_column(u'catalog_userprofile', 'yt_channel_url', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.twitter_url'
        db.alter_column(u'catalog_userprofile', 'twitter_url', self.gf('django.db.models.fields.URLField')(default='', max_length=1000))

        # Changing field 'UserProfile.facebook_url'
        db.alter_column(u'catalog_userprofile', 'facebook_url', self.gf('django.db.models.fields.URLField')(default='', max_length=1000))

        # Changing field 'UserProfile.linkedin_url'
        db.alter_column(u'catalog_userprofile', 'linkedin_url', self.gf('django.db.models.fields.URLField')(default='', max_length=1000))

        # Changing field 'UserProfile.instructables_url'
        db.alter_column(u'catalog_userprofile', 'instructables_url', self.gf('django.db.models.fields.URLField')(default='', max_length=1000))

        # Changing field 'UserProfile.github_url'
        db.alter_column(u'catalog_userprofile', 'github_url', self.gf('django.db.models.fields.URLField')(default='', max_length=1000))

        # Changing field 'UserProfile.blog_url'
        db.alter_column(u'catalog_userprofile', 'blog_url', self.gf('django.db.models.fields.URLField')(default='', max_length=1000))

        # Changing field 'UserProfile.stackoverflow_url'
        db.alter_column(u'catalog_userprofile', 'stackoverflow_url', self.gf('django.db.models.fields.URLField')(default='', max_length=1000))

        # Changing field 'UserProfile.website_url'
        db.alter_column(u'catalog_userprofile', 'website_url', self.gf('django.db.models.fields.URLField')(default='', max_length=1000))

        # Changing field 'UserProfile.yt_channel_url'
        db.alter_column(u'catalog_userprofile', 'yt_channel_url', self.gf('django.db.models.fields.URLField')(default='', max_length=1000))
