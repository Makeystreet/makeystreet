...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Note'
        db.create_table(u'catalog_note', (
        ...
        db.send_create_signal(u'catalog', ['Note'])

        # Adding M2M table for field notes on 'Makey'
        m2m_table_name = db.shorten_name(u'catalog_makey_notes')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('makey', models.ForeignKey(orm[u'catalog.makey'], null=False)),
            ('note', models.ForeignKey(orm[u'catalog.note'], null=False))
        ))
        db.create_unique(m2m_table_name, ['makey_id', 'note_id'])


    def backwards(self, orm):
        # Deleting model 'Note'
        db.delete_table(u'catalog_note')

        # Removing M2M table for field notes on 'Makey'
        db.delete_table(db.shorten_name(u'catalog_makey_notes'))
