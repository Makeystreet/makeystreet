...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TextDocumentation.order'
        db.add_column(u'catalog_textdocumentation', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TextDocumentation.order'
        db.delete_column(u'catalog_textdocumentation', 'order')
