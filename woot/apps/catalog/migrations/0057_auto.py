...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field makeys_as_tools on 'Product'
        m2m_table_name = db.shorten_name(u'catalog_product_makeys_as_tools')
    ...
    def backwards(self, orm):
        # Removing M2M table for field makeys_as_tools on 'Product'
        db.delete_table(db.shorten_name(u'catalog_product_makeys_as_tools'))
