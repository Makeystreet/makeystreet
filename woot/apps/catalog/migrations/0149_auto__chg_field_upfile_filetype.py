...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UpFile.filetype'
        db.alter_column(u'catalog_upfile', 'filetype', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'UpFile.filetype'
        db.alter_column(u'catalog_upfile', 'filetype', self.gf('django.db.models.fields.CharField')(max_length=50))
