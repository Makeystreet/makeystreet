...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field modules_used on 'Makey'
        m2m_table_name = db.shorten_name(u'catalog_makey_modules_used')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_makey', models.ForeignKey(orm['catalog.makey'], null=False)),
            ('to_makey', models.ForeignKey(orm['catalog.makey'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_makey_id', 'to_makey_id'])


    def backwards(self, orm):
        # Removing M2M table for field modules_used on 'Makey'
        db.delete_table(db.shorten_name(u'catalog_makey_modules_used'))
