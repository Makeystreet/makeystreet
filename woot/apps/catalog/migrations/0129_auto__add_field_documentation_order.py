...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Documentation.order'
        db.add_column(u'catalog_documentation', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Documentation.order'
        db.delete_column(u'catalog_documentation', 'order')
