...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'catalog_newuser', (
        ...
        db.send_create_signal('catalog', ['NewUser'])

        # Adding M2M table for field new_users on 'Makey'
        m2m_table_name = db.shorten_name(u'catalog_makey_new_users')
        ...
        db.create_unique(m2m_table_name, ['makey_id', 'newuser_id'])


        # Changing field 'Makey.name'
        db.alter_column(u'catalog_makey', 'name', self.gf('django.db.models.fields.CharField')(default='current_makey', max_length=200))

    def backwards(self, orm):
        # Deleting model 'NewUser'
        db.delete_table(u'catalog_newuser')

        # Removing M2M table for field new_users on 'Makey'
        db.delete_table(db.shorten_name(u'catalog_makey_new_users'))


        # Changing field 'Makey.name'
        db.alter_column(u'catalog_makey', 'name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
