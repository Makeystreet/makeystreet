...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Documentation.title'
        db.add_column(u'catalog_documentation', 'title',
    ...
    def backwards(self, orm):
        ...
        db.create_table(m2m_table_name, (
            ...
            ('makeyimage', models.ForeignKey(orm['catalog.makeyimage'], null=False))
        ))
        db.create_unique(m2m_table_name, ['makey_id', 'makeyimage_id'])

        # Deleting field 'Documentation.title'
        db.delete_column(u'catalog_documentation', 'title')
