...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field new_parts on 'Makey'
        m2m_table_name = db.shorten_name(u'catalog_makey_new_parts')
    ...
    def backwards(self, orm):
        # Removing M2M table for field new_parts on 'Makey'
        db.delete_table(db.shorten_name(u'catalog_makey_new_parts'))
