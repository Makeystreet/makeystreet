...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LikeArticle'
        db.create_table(u'catalog_likearticle', (
            ...
            ('article', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Article'])),
        ))
        db.send_create_signal('catalog', ['LikeArticle'])

        # Adding unique constraint on 'LikeArticle', fields ['user', 'article']
        db.create_unique(u'catalog_likearticle', ['user_id', 'article_id'])


        # Changing field 'Article.image_url'
        db.alter_column(u'catalog_article', 'image_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):
        # Removing unique constraint on 'LikeArticle', fields ['user', 'article']
        db.delete_unique(u'catalog_likearticle', ['user_id', 'article_id'])

        # Deleting model 'LikeArticle'
        db.delete_table(u'catalog_likearticle')


        # Changing field 'Article.image_url'
        db.alter_column(u'catalog_article', 'image_url', self.gf('django.db.models.fields.URLField')(default='http://placehold.it/400x300', max_length=200))
