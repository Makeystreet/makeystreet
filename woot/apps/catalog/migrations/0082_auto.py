...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'catalog_userprofile_following')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_userprofile', models.ForeignKey(orm['catalog.userprofile'], null=False)),
            ('to_userprofile', models.ForeignKey(orm['catalog.userprofile'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'catalog_userprofile_following'))
    ...
    models = {
        ...
        'catalog.userprofile': {
            ...
            'added_time': ('django.db.models.fields.DateTimeField', [], {}),
            'following': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'folowers'", 'symmetrical': 'False', 'to': "orm['catalog.UserProfile']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'score': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
