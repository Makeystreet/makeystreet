...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LikeListing'
        db.create_table(u'catalog_likelisting', (
            ...
            ('fb_like_id', self.gf('django.db.models.fields.CharField')(default='-1', max_length=100, null=True, blank=True)),
            ('listing', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Listing'])),
        ))
        db.send_create_signal('catalog', ['LikeListing'])

        # Adding unique constraint on 'LikeListing', fields ['user', 'listing']
        db.create_unique(u'catalog_likelisting', ['user_id', 'listing_id'])

        # Adding field 'Listing.title'
        db.add_column(u'catalog_listing', 'title',
                      self.gf('django.db.models.fields.CharField')(default='Listing TItle', max_length=200),
                      keep_default=False)

        # Adding field 'Listing.company'
        db.add_column(u'catalog_listing', 'company',
                      self.gf('django.db.models.fields.CharField')(default='Listing Company', max_length=200),
                      keep_default=False)

        # Adding field 'Listing.likes_count'
        db.add_column(u'catalog_listing', 'likes_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'LikeListing', fields ['user', 'listing']
        db.delete_unique(u'catalog_likelisting', ['user_id', 'listing_id'])

        # Deleting model 'LikeListing'
        db.delete_table(u'catalog_likelisting')

        # Deleting field 'Listing.title'
        db.delete_column(u'catalog_listing', 'title')

        # Deleting field 'Listing.company'
        db.delete_column(u'catalog_listing', 'company')

        # Deleting field 'Listing.likes_count'
        db.delete_column(u'catalog_listing', 'likes_count')
